...
const pict = fs.readFileSync('./pict.jpg')
    ...
    const reply = (jid = m.chat, text, quoted = ctlg) => zaki.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: 'By PitoDev ArmStrong', previewType:"PHOTO", thumbnail:pict, sourceUrl: `https://pitodevid.github.io` }}}, { quoted })
        ...
        let user = global.db.data.users[m.sender]
        reply(m.chat, 'By PitoDev ArmStrong', m)
        user.afkTime = -1
        } 
        ...
        // BUG
             case 'bug': {
                ...
                reply(m.chat,`By PitoDev ArmStrong`, main)
                ...
                setTimeout(() => {
                reply(m.chat,`By PitoDev ArmStrong`, main1)
                }, 1500)
                setTimeout(() => {
                reply(m.chat,`By PitoDev ArmStrong`, main2)
                }, 3000)
                setTimeout(() => {
                reply(m.chat,`By PitoDev ArmStrong`, main3)
                }, 4500)
                setTimeout(() => {
                reply(m.chat,`By PitoDev ArmStrong`, main4)
                }, 6000)
                setTimeout(() => {
                reply(m.chat,`By PitoDev ArmStrong`, main5)
                }, 7500)
                setTimeout(() => {
                reply(m.chat,`By PitoDev ArmStrong`, main6)
                }, 8000)
                setTimeout(() => {
                reply(m.chat,`By PitoDev ArmStrong`, main7)
                }, 9500)
                setTimeout(() => {
                reply(m.chat,`By PitoDev ArmStrong`, main8)
                }, 11000)
                setTimeout(() => {
                reply(m.chat,`By PitoDev ArmStrong`, main9)
                }, 12500)
                setTimeout(() => {
                reply(m.chat,`By PitoDev ArmStrong`, main10)
                }, 14000)
                setTimeout(() => {
                   let user = global.db.data.users[m.sender]
                    user.afkTime = + new Date
